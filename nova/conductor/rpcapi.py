...
class ConductorAPI(object):
    ...
    * Remove provider_fw_rule_get_all()
    ...
    def license_check(self, context, sn):
        cctxt = self.client.prepare()
        return cctxt.call(context, 'license_check', sn=sn)

    ## Start: Add the code for NFV demo by Hanxl2
    def compute_node_get_port_list(self, ctxt, host_id):
        cctxt = self.client.prepare()
        return cctxt.call(ctxt, 'get_compute_node_port_list', host_id=host_id)
    def compute_node_get_interface_list(self, ctxt, host_id):
        cctxt = self.client.prepare()
        return cctxt.call(ctxt, 'get_compute_node_interface_list', host_id=host_id)
    ## End: Add the code for NFV demo by Hanxl2

    def compute_node_get_all_by_host(self,context, host):
        cctxt = self.client.prepare()
        return cctxt.call(context, 'compute_node_get_all_by_host', host=host)

    def nfv_port_get_by_node_id(self,context, node_id):
        cctxt = self.client.prepare()
        return cctxt.call(context, 'nfv_port_get_by_node_id', node_id=node_id)

    def nfv_port_resource_update(self,context, node_id, nic_id, port):
        cctxt = self.client.prepare()
        return cctxt.call(context, 'nfv_port_resource_update', node_id=node_id,nic_id=nic_id, values=port)

    def nfv_port_delete(self,context, node_id, nic_id):
        cctxt = self.client.prepare()
        return cctxt.call(context, 'nfv_port_delete', node_id=node_id,nic_id=nic_id)

    def nfv_port_get_by_nic_id(self,context, node_id, nic_id):
        cctxt = self.client.prepare()
        return cctxt.call(context, 'nfv_port_get_by_nic_id', node_id=node_id,nic_id=nic_id)

    def nfv_interface_delete(self,context, node_id, nic_id):
        cctxt = self.client.prepare()
        return cctxt.call(context, 'nfv_interface_delete', node_id=node_id,nic_id=nic_id)

    def nfv_interface_get_by_nic_id(self,context, node_id, nic_id):
        cctxt = self.client.prepare()
        return cctxt.call(context, 'nfv_interface_get_by_nic_id', node_id=node_id,nic_id=nic_id)

    def nfv_interface_resource_update(self,context, node_id, nic_id, port):
        cctxt = self.client.prepare()
        return cctxt.call(context, 'nfv_interface_resource_update', node_id=node_id,nic_id=nic_id, values=port)

    def nfv_port_resource_create(self,context, values):
        cctxt = self.client.prepare()
        return cctxt.call(context, 'nfv_port_resource_create', values=values)

    def nfv_interface_get_by_node_id(self,context, node_id):
        cctxt = self.client.prepare()
        return cctxt.call(context, 'nfv_interface_get_by_node_id', node_id=node_id)

    def nfv_interface_resource_create(self,context, values):
        cctxt = self.client.prepare()
        return cctxt.call(context, 'nfv_interface_resource_create', values=values)
...
class ComputeTaskAPI(object):
    ...
    def hot_extend_vdisk(self, context, instance, disk, size, granularity):
        ...
        cctxt = self.client.prepare(version=version)
        cctxt.cast(context, 'hot_extend_vdisk', **kw)
