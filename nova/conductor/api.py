...
class LocalAPI(object):
    ...
    def license_check(self, context, sn):
        return self._manager.license_check(context, sn)
    ...
    def object_backport_versions(self, context, objinst, object_versions):
        return self._manager.object_backport_versions(context, objinst,
                                                      object_versions)
    ## Start: Add the code for NFV demo by Hanxl2
    def compute_node_get_port_list(self, context, host_id):
        return self._manager.compute_node_get_port_list(context, host_id)
    def compute_node_get_interface_list(self, context, host_id):
        return self._manager.compute_node_get_interface_list(context, host_id)
    ## End: Add the code for NFV demo by Hanxl2

    def compute_node_get_all_by_host(self,context, host):
        return self._manager.compute_node_get_all_by_host(context, host)

    def nfv_port_get_by_node_id(self,context, node_id):
        return self._manager.nfv_port_get_by_node_id(context, node_id)

    def nfv_port_resource_update(self,context, node_id, nic_id, port):
        return self._manager.nfv_port_resource_update(context, node_id, nic_id, port)

    def nfv_port_delete(self,context, compute_node_id, nic_id):
        return self._manager.nfv_port_delete(context, compute_node_id, nic_id)

    def nfv_port_get_by_nic_id(self,context, node_id, nic_id):
        return self._manager.nfv_port_get_by_nic_id(context, node_id, nic_id)

    def nfv_interface_delete(self,context, compute_node_id, nic_id):
        return self._manager.nfv_interface_delete(context, compute_node_id, nic_id)

    def nfv_interface_get_by_nic_id(self,context, node_id, nic_id):
        return self._manager.nfv_interface_get_by_nic_id(context, node_id, nic_id)

    def nfv_interface_resource_update(self,context, node_id, nic_id, port):
        return self._manager.nfv_interface_resource_update(context, node_id, nic_id, port)

    def nfv_port_resource_create(self,context, values):
        return self._manager.nfv_port_resource_create(context, values)

    def nfv_interface_get_by_node_id(self,context, compute_node_id):
        return self._manager.nfv_interface_get_by_node_id(context, compute_node_id)

    def nfv_interface_resource_create(self,context, values):
        return self._manager.nfv_interface_resource_create(context, values)
...
class LocalComputeTaskAPI(object):
    ...
    def hot_extend_vdisk(self, context, instance, disk, size, granularity):
        utils.spawn_n(self._manager.build_instances, context, instance, disk, size, granularity)
...
class ComputeTaskAPI(object):
    ...
    def hot_extend_vdisk(self, context, instance, disk, size, granularity):
        self.conductor_compute_rpcapi.hot_extend_vdisk(context, instance, disk, size, granularity)
