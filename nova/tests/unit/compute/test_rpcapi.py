...
class ComputeRpcAPITestCase(test.NoDBTestCase):
    ...
    def test_enable_zram(self):
        self._test_compute_api('enable_zram', 'call', host='host', action='action')

    def test_disable_zram(self):
        self._test_compute_api('disable_zram', 'call', host='host', action='action')

    def test_get_zram_status(self):
        self._test_compute_api('get_zram_status', 'call', host='host', action='action')

    def test_host_ksm_ctl(self):
        self._test_compute_api('host_ksm_ctl', 'call', action='action',
                host='host')
