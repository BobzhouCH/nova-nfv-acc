...
class NfvPortResource(BASE, NovaBase):
    """Represents nfv port resource."""
    __tablename__ = "nfv_port_resource"
    id = Column(Integer, primary_key=True, autoincrement=True)
    node_id = Column(Integer, nullable=True)
    nic_id = Column(String(length=255), nullable=True)
    name = Column(String(length=255), nullable=True)
    mac = Column(String(length=255), nullable=True)
    pci = Column(String(length=255), nullable=True)
    pci_passthrough_supported = Column(String(length=255),default='yes')
    pci_sriov_supported = Column(String(length=255),default='yes')
    max_vfnum = Column(Integer, nullable=True)
    processor = Column(Integer, nullable=True)
    auto = Column(String(length=255), nullable=True)
    device = Column(String(length=255),nullable=True)
    created_at = Column(DateTime, default=timeutils.utcnow)
    updated_at = Column(DateTime, onupdate=timeutils.utcnow)
    deleted_at = Column(DateTime)
    deleted = Column(String(36), default="")
class NfvInterfaceResource(BASE, NovaBase):
    """Represents nfv interface resource."""
    __tablename__ = "nfv_interface_resource"
    id = Column(Integer, primary_key=True, autoincrement=True)
    node_id = Column(Integer, nullable=True)
    nic_id = Column(String(length=255), nullable=True)
    name = Column(String(length=255), nullable=True)
    network_type = Column(String(length=255), nullable=True)
    last_network_type = Column(String(length=255), nullable=True)
    provider_networks = Column(String(length=255), nullable=True)
    type =  Column(String(length=255), nullable=True)
    vlan_id =  Column(String(length=255), nullable=True)
    ports =  Column(String(length=255), nullable=True)		
    vfnum = Column(Integer, nullable=True)
    support_config = Column(String(length=255),default='yes')
    uses = Column(String(length=255),nullable=True)
    used_by = Column(String(length=255),nullable=True)
    attributes = Column(String(length=255),nullable=True)
    created_at = Column(DateTime, default=timeutils.utcnow)
    updated_at = Column(DateTime, onupdate=timeutils.utcnow)
    deleted_at = Column(DateTime)
    deleted = Column(String(36), default="")
