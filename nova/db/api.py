...
def flavor_get_exactly(context, inactive=False, filters=None):
    return IMPL.flavor_get_exactly(
...
def nfv_port_resource_create(context, values):
    """Create a new nfv_port_resource."""
    return IMPL.nfv_port_resource_create(context, values)


def nfv_port_get_all(context):
    return IMPL.nfv_port_get_all(context)


def nfv_port_get_by_node_id(context, compute_node_id):
    return IMPL.nfv_port_get_by_node_id(context, compute_node_id)


def nfv_port_resource_update(context, compute_node_id, nic_id, values):
    """Update the record in DB."""
    return IMPL.nfv_port_resource_update(context, compute_node_id, nic_id, values)


def nfv_port_delete(context, compute_node_id, nic_id):
    """Delete a nfv port record."""
    return IMPL.nfv_port_delete(context, compute_node_id, nic_id)


def nfv_port_get_by_nic_id(context, node_id, nic_id):
    """Get a nfv port record by id."""
    return IMPL.nfv_port_get_by_nic_id(context, node_id, nic_id)
...
def nfv_interface_resource_create(context, values):
    """Create a new nfv_interface_resource."""
    return IMPL.nfv_interface_resource_create(context, values)


def nfv_interface_get_all(context):
    return IMPL.nfv_interface_get_all(context)


def nfv_interface_get_by_node_id(context, compute_node_id):
    return IMPL.nfv_interface_get_by_node_id(context, compute_node_id)


def nfv_interface_resource_update(context, compute_node_id, nic_id, values):
    """Update the record in DB."""
    return IMPL.nfv_interface_resource_update(context, compute_node_id, nic_id, values)


def nfv_interface_delete(context, compute_node_id, nic_id):
    """Delete a nfv interface record."""
    return IMPL.nfv_interface_delete(context, compute_node_id, nic_id)


def nfv_interface_get_by_nic_id(context, node_id, nic_id):
    """Get a nfv interface record by id."""
    return IMPL.nfv_interface_get_by_nic_id(context, node_id, nic_id)
