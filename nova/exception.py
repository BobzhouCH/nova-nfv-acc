...
class InvalidInputForSettingActualTotalMemory(NovaException):
    msg_fmt = _("Invalid input size for setting actual total memory: %(reason)s")
...
class NfvPortNotFound(NotFound):
    msg_fmt = _("Nfv Port record %(port) could not be found.")
